/* ============================================================
   ...
   النسخة 3: تعرض المخزَّن فورًا وتحدّث في الخلفية، وتخزّن الخطوط.

   عند رفع تحديث مستقبلًا: غيّر الرقم في السطر التالي فقط
   (hisas-v15 ← hisas-v16) ليأخذ الجوال النسخة الجديدة.
   ملاحظة: التحديث يُثبَّت في الخلفية فور الفتح، ويعرض التطبيق وقتها
   شريط «يوجد تحديث» فورًا — لا داعي لانتظار فتح ثانٍ.
   ============================================================ */
const CACHE = "hisas-v15";
